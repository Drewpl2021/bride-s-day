...
const CONFIG = {
    birthdayDate: '2025-08-01', // Fecha del cumpleaños: 7 de agosto
    birthdayName: 'Mi Princesa Deysy', // Cambia por el nombre real
    yourName: 'Tu Príncipe A', // Cambia por tu nombre
...
const surprises = {
    ...
    2: {
        ...
        content: `
            <div class="surprise-content">
                <h2>💌 Un mensaje del corazón 💖</h2>
                <p>💘 Eres la mejor novia del mundo, mi amor. Cada vez que te veo, mi día se ilumina con tu sonrisa 🌞😊.</p><br>
                <p>🌟 Espero que a futuro podamos seguir juntos 🤝 y cumplamos todos los planes 🗓️, sueños ✨ y metas 🎯 de los que hablamos, mi amor 💑.</p><br>
                <p>💭 Aunque no estoy contigo, espero que te haya gustado todo, mi amor 💐. Y aunque no es el primer Día de la Novia que te celebran 🎉,</p><br>
                <p>💝 Espero que este sea uno de tus favoritos, mi amor 🥰.</p><br>
                <p>❤️ Te amo mucho, mi Deysy 😘💋</p>
    ...
    3: {
        ...
        content: `
            <div class="surprise-content">
                <h2>🎀 Mi deseo para ti, princesa 👑</h2>
                <p>💖 Hoy es un día muy especial porque se celebra a la mejor novia del mundo 🌎💫</p><br>
                <p>😊 Espero que en este tiempo que pasamos hayas sido feliz 🌈, y que sigas siendo feliz a mi lado 🤗💞</p><br>
                <p>🎁 Cuando estemos juntos te daré tu regalo, preciosa 💝, pero de verdad deseo que siempre seas feliz aunque yo no esté, mi amor 🌹✨</p><br>
                <p>🥗 Tienes que cuidarte, comer 🍽️ y tomar mucha agüita 💧 mi amor 😘</p><br>
                <p>❤️‍🔥 Te amo 💋</p>
    ...
    4: {
        ...
        content: `
            <div class="surprise-content">
                <h2>💖 ¡Celebremos nuestro amor! 💑</h2>
                <p>Hoy no es solo un día cualquiera... es tu día, mi amor. Un momento para recordarte lo valiosa y especial que eres🌹.</p><br>
                <p>Gracias por ser esa persona que llena mi vida de ternura, comprensión y alegría 🕊️✨.</p><br>
                <p>Me encantaría estar a tu lado abrazándote y mimándote como mereces, cuando nos encontremos lo hare, saldremos un dia y celebraremos este dia como se merece mi amor💗.</p><br>
                <p>¡Feliz Día de la Novia, mi reina! 👸💕</p>
    ...
    function typeNextChar() {
        if (currentIndex < fullText.length) {
            ...
            setTimeout(() => {
                ...
                showSpecialNotification('💌 Mi carta especial está completa para ti, Deysy', 'romantic');
            }, 500);
        }
    }
...
setTimeout(() => {
    showSpecialNotification('¡Bienvenida a tu página especial, mi princesa Deysy! 💖', 'romantic');
}, 1000);
...
function addCountdownButton() {
    ...
    countdownButton.innerHTML = `
        <div class="countdown-info">
            <h3>❤️ ¿Quieres ver el contador?</h3>
            <p>El contenido especial se desbloqueará el 1 de agosto de 2025</p>
